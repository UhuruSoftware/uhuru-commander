...
$.widget( "ui.accordion", {
	...
	refresh: function() {
		...
		if ( heightStyle === "fill" ) {
			...
			// we use the minHeight support spec because we assume that only
...
$.widget( "ui.menu", {
	...
	select: function( event ) {
		...
		// point, but the spec don't trigger mouseenter before click.
